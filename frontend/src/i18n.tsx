...
const messages: Record<Language, Record<string, string>> = {
  en: {
    ...
    'graphs.expandTitle': 'Expand',
    'graphs.collapseTitle': 'Collapse',
    'graphs.subgraphsLoading': 'Loading subgraphs...',
    'graphs.subgraphsEmpty': 'No subgraphs found.',
    ...
    'drawer.notesCount': '{count} tips',
    'drawer.addItemPlaceholder': 'Add an item...',
    'drawer.addItem': 'Add Item',
    'drawer.addItemModalSubtitle': 'Create an item and choose where to place it.',
    'drawer.itemParentLabel': 'Directory',
    'drawer.itemParentRoot': 'Top level',
    ...
    'itemNotes.title': 'Item Notes',
    'itemNotes.subtitle': 'Use rich text blocks to document this item.',
    'itemNotes.placeholder': 'Start writing notes for this item...',
    'itemNotes.empty': 'Item not found. Go back to the graph and try again.',

    'itemModal.eyebrow': 'Item Tips',
    'itemModal.close': 'Close',
    'itemModal.notesCount': '{count} tips',
    'itemModal.empty': 'No tips yet. Add the first one below.',
    'itemModal.remove': 'Remove',
    'itemModal.addPlaceholder': 'Add a tip description...',
    'itemModal.addNote': 'Add Tip',
    ...
    'modal.delete': 'Delete',
    'modal.cancel': 'Cancel',
    'about.title': 'About GWeb',
    'about.subtitle': 'Need help or want to get in touch?',
    'about.contactLabel': 'Contact',
    'about.credit': 'Developed with Yuanzheng Hu and Codex.',
  ...
  zh: {
    ...
    'graphs.expandTitle': '展开',
    'graphs.collapseTitle': '收起',
    'graphs.subgraphsLoading': '正在加载子图谱...',
    'graphs.subgraphsEmpty': '暂无子图谱。',
    ...
    'drawer.notesCount': '{count} 条提示',
    'drawer.addItemPlaceholder': '添加条目...',
    'drawer.addItem': '添加条目',
    'drawer.addItemModalSubtitle': '创建条目并选择放置目录。',
    'drawer.itemParentLabel': '目录',
    'drawer.itemParentRoot': '顶层',
    'drawer.addNote': '添加笔记',
    'drawer.openItem': '打开',
    ...
    'itemNotes.title': '条目笔记',
    'itemNotes.subtitle': '使用富文本块为该条目记录信息。',
    'itemNotes.placeholder': '开始为该条目写笔记...',
    'itemNotes.empty': '未找到该条目，请返回图谱后重试。',

    'itemModal.eyebrow': '条目提示',
    'itemModal.close': '关闭',
    'itemModal.notesCount': '{count} 条提示',
    'itemModal.empty': '暂无提示。',
    'itemModal.remove': '删除',
    'itemModal.addPlaceholder': '添加提示描述...',
    'itemModal.addNote': '添加提示',
    ...
    'modal.cancel': '取消',
    'about.title': '关于 GWeb',
    'about.subtitle': '如需帮助或联系，请使用以下信息。',
    'about.contactLabel': '联系方式',
    'about.credit': '由 Yuanzheng Hu 与 Codex 共同开发。',
